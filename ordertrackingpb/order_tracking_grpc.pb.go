...
const (
	OrderTrackingService_SubscribeToOrderUpdates_FullMethodName = "/ordertrackingpb.OrderTrackingService/SubscribeToOrderUpdates"
)
...
var OrderTrackingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ordertrackingpb.OrderTrackingService",
